...
const fourWidgetLayout: WidgetLayout[] = [
  ...
  { i: "table-primary", x: 0, y: 6, w: 6, h: 4, minW: 4, minH: 3 },
  { i: "table-secondary", x: 6, y: 6, w: 6, h: 4, minW: 4, minH: 3 },
  { i: "table-tertiary", x: 0, y: 10, w: 6, h: 4, minW: 4, minH: 3 },
...
> = {
    ...
    widgets: [
      ...
      },
      {
        ...
        data: {
          ...
          bullets: [
            "Enterprise deal velocity improved",
            "Regional mix remains balanced",
            "Late-stage risk is concentrated in APAC",
          ],
        },
      },
    ],
  ...
  support_operations: {
    ...
    description:
      "Case volume, critical case, SLA risk, and escalation tracking view.",
    ...
    widgets: [
      ...
      },
      {
        ...
        data: {
          ...
          bullets: [
            "Billing cases carry the highest risk",
            "Response time is improving",
            "Critical queue needs focused triage",
          ],
        },
      },
    ],
    ...
    widgets: [
      ...
      },
      {
        ...
        data: {
          ...
          severity: "info",
          summary:
            "The combined business signal is healthy with localized support risk.",
          bullets: [
            "Revenue trend offsets SLA exposure",
            "Strategic pipeline quality improved",
            "Northwest variance needs monitoring",
          ],
        },
      },
    ],
    ...
    widgets: [
...

      {
        ...
        data: {
          ...
          severity: "info",
          summary:
            "Revenue strength is carrying the overall business health signal.",
          bullets: [
            "Sales momentum remains positive",
            "Support risk requires executive visibility",
            "Pipeline quality improved in strategic segments",
          ],
        },
      },
    ],
...
export const dashboardById = Object.values(dashboardByTemplate).reduce<
  Record<string, DashboardConfiguration>
